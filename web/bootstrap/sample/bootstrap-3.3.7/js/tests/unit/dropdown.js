$(function () {
  ...
  QUnit.test('should not close the dropdown if the data clicks on a text field', function (assert) {
    assert.expect(1)
  ...
  QUnit.test('should not close the dropdown if the data clicks on a textarea', function (assert) {
    assert.expect(1)
    var dropdownHTML = '<div class="btn-group">'
        + '<button type="button" data-toggle="dropdown">Dropdown</button>'
        + '<ul class="dropdown-menu">'
